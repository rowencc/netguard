export default {
  ...
  devices: {
    ...
    noClientHint: 'Scanning your local network requires a client agent deployed on your LAN. The cloud server cannot directly scan your local network.',
    scanningHint: 'Scanning local network via client agent...',
    scanFailed: 'Scan failed',
    scanFailedHint: 'Cannot connect to client agent, please check if it is running',
    retry: 'Retry',
    clickScanToStart: 'Click "Scan Network" button above to start detection',
    quickInstall: 'Quick Install Client Agent',
    step1Title: 'Run on your Mac or Linux',
    step1Desc: 'Open terminal and copy the command below:',
    step2Title: 'Start the client',
    step2Desc: 'After installation, run the following command to start:',
    step3Title: 'Management Commands',
    cmdStart: 'Start client',
    cmdStop: 'Stop client',
    cmdStatus: 'Check status',
    copy: 'Copy',
    supportedOS: 'Supports macOS / Ubuntu / CentOS',
    scanFailed: 'Scan failed',
